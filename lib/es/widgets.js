...
//				this.cluster.get("_cluster/nodes/stats", this._clusterNodeStats_handler);
				...
				acx.each(status.indices, function(name, index) {
					index.aliases.forEach(function(alias) {
						...
						aliasRow.indices[indexIndex] = true;
					});
				});
		...
		_newIndex_handler: function() {
			new acx.ui.DialogPanel({
				title: "New Index",
				body: [
					{ tag: "LABEL", children: [
						"Index Name",
						{ tag: "INPUT", type: "text", name: "_name" }
					]},
					{ tag: "LABEL", children: [
						"Number of Shards",
						{ tag: "INPUT", type: "text", name: "number_of_shards"}
					]},
					{ tag: "LABEL", children: [
						"Number of Shards",
						{ tag: "INPUT", type: "text", name: "number_of_replicas"}
					]}
				],
			...
			return { tag: "DIV", cls: "nodeVisualiser", children: [
				...
				{ tag: "DIV", cls: "nodeVisualiser-nodes", child: { tag: "TABLE", cellspacing: 10, child: { tag: "TBODY", child: { tag: "TR", children: acx.eachMap(data.nodes, function(id, data) {
					...
					return { tag: "TD", onClick: function() {
						new acx.ui.InfoPanel({ title: id, modal: false, autoRemove: true, open: true, body: new es.JsonPretty({ obj: data }) });
					}, children: [
						{ tag: "DIV", text: "id: " + id },
