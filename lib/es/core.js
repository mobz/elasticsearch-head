...
Converter for columns can access to folowing variables: 
  ...
  */
        ...
        if(columnDefs){
          for(var name in columnDefs){
            ...
            if(typeof column.converter != "undefined" 
               && typeof columnConverter[column.converter] != "undefined"){
            ...
            row[name] = columnConverter[converter](hit, column);
          }
        }else{
  ...
  function ColumnConverter() {
    ...
    this.value = function(hit, column){
      return {value:this.resolveProperty(hit, column.path), isHTML:false};
    };

    this.fileLink = function(hit, column){
      var value = this.resolveProperty(hit, column.path);
      return {value:"<a href=\"file://" + value + "/\" target=\"_blank\">" + value + "</a>", isHTML:true};
    };

    this.httpLink = function(hit, column){
      var value = this.resolveProperty(hit, column.path);
      return {value:"<a href=\"http://" + value + "/\" target=\"_blank\">" + value + "</a>", isHTML:true};
    };
  };
