...
acx.ui.Table = acx.ui.Widget.extend({
	...
	_body_template: function(data, columns) {
		return { tag: "TABLE", children: []
          ...
          var cell = (row[column] || "");
          if(cell.isHTML != "undefined"){
             if(cell.isHTML){
              return { tag: "TD", cls: "uiTable-cell", child: { tag: "DIV", html: (cell.value || "").toString()  } };
             }else{
              return { tag: "TD", cls: "uiTable-cell", child: { tag: "DIV", text: (cell.value || "").toString()  } };
             }
          }else{
             return { tag: "TD", cls: "uiTable-cell", child: { tag: "DIV", text: cell.toString() } };
          }
				})};
			}))
		};
