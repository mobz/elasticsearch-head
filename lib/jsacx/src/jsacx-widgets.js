	...
	_body_template: function(data, columns) {
		return { tag: "TABLE", children: []
          ...
          if(cell.isHTML != "undefined"){
             if(cell.isHTML){
              return { tag: "TD", cls: "uiTable-cell", child: { tag: "DIV", html: cell.value } };
             }else{
              return { tag: "TD", cls: "uiTable-cell", child: { tag: "DIV", text: cell.value } };
             }
          }else{
             return { tag: "TD", cls: "uiTable-cell", child: { tag: "DIV", text: cell } };
          }
				})};
			}))
		};
