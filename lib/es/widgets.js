			...
			return { tag: "DIV", cls: "es", children: [
				{ tag: "DIV", id: this.id("header"), cls: "es-header", children: [
					...
					{ tag: "DIV", cls: "es-header-menu", children: [
						...
						{ tag: "DIV", cls: "es-header-menu-item es-left", text: acx.text("Nav.AnyRequest"), onclick: this._openAnyRequest_handler },
	...
	es.FilterBrowser = es.AbstractQuery.extend({
		...
		_main_template: function() {
			return { tag: "DIV", children: [
				...
				{ tag: "LABEL", children: [
					"Output Results: ",
					{ tag: "SELECT", cls: "es-filterBrowser-outputFormat", children: [ acx.text("Output.Table"), acx.text("Output.JSON")].map(acx.ut.option_template) }
				]},
