...
* If you've installed Elasticsearch via Homebrew, plugin executable will be available at @/usr/local/Cellar/elasticsearch/(elasticsearch version)/@. For installation run @bin/plugin install mobz/elasticsearch-head@
...
and follow existing dev patterns, such as indenting with tabs
